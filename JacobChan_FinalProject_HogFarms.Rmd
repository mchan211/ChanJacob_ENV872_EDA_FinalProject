...
```
>Figure 3. Bar graph of various population distributions within each county
...
```
> Figure 4. Bar graph showing incidence rates of heart disease and cancer within each county
...
```
> Figure 5. Bar graph of various health risk indicators within each county
...
```
> Figure 6. Bar graph of infant mortality and low birthweight risk within each county
...
```
> Figure 7. Bar graph of the distribution of vulnerable populations within each county

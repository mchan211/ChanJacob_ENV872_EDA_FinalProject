...
> Table 1. Table showing description of variables and units used in the study 
...
- A piped statement was used to select the counties we were interested in and rename the column names
- Transpose function was used to interchange data present in rows and columns (x,y) to for easier visualization
- A piped statement was used to rename column names again due to the use of the 'Transpose' function
...
**Question 3: What health inequities are most prevalant in counties with  high concentrations of hog farms?**
